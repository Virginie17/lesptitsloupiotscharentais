                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-gray-600">
                                    <div className="space-y-2">
                                        <p className="flex items-start gap-2">
                                            <span className="text-rose-powder mt-1">•</span>
                                            <span><strong>Crédit d&apos;impôt :</strong> Bénéficiez de 50% de crédit d&apos;impôt sur les sommes versées</span>
                                        </p>
                                        <p className="flex items-start gap-2">
                                            <span className="text-rose-powder mt-1">•</span>
                                            <span><strong>Paiement :</strong> CESU accepté (Chèque Emploi Service Universel)</span>
                                        </p>
                                        <p className="flex items-start gap-2">
                                            <span className="text-rose-powder mt-1">•</span>
