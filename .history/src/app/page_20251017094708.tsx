              ...
              <div className="flex justify-center animate-scale-in">
                <div className="relative group">
                  <Image
                    ...
                    width={500}
                    height={500}
                    className="w-full max-w-md rounded-3xl shadow-2xl object-cover animate-fade-in-up group-hover:scale-105 transition-transform duration-500"
                    priority
                  />
                  {/* Effet de brillance au survol */}
                  <div className="absolute inset-0 rounded-3xl bg-gradient-to-tr from-rose-powder/0 via-white/20 to-rose-powder/0 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                  {/* Bordure décorative */}
                  <div className="absolute -inset-4 bg-gradient-to-r from-rose-powder/30 to-blue-sky/30 rounded-3xl -z-10 blur-xl animate-pulse-soft"></div>
                </div>
              </div>
            </div>
          </div>
