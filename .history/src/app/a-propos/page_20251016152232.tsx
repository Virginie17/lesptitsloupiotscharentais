import Link from "ne					<h1 className="text-4xl md:text-5xl font-bold text-gray-dark animate-fade-in-up">
...
import { Award, GraduationCap, Heart, Shield, Clock, Sun, Star } from "lucide-react"
	...
	return (
		<div className="animate-fade-in">
			...
			<section className="py-12 md:py-16">
				<div className="container mx-auto px-4">
					<div className="max-w-2xl mx-auto bg-white rounded-3xl shadow-lg p-8 md:p-12 animate-scale-in">
