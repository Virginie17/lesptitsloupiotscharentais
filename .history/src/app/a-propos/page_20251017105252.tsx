        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="mt-16 animate-fade-in-up">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-5xl mx-auto mb-8">
              {/* Photo 1 - Grande à gauche - Peinture */}
              <div className="col-span-2 row-span-2 relative overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-[1.02] animate-fade-in-up group"
                   style={{ borderRadius: '25% 75% 70% 30% / 30% 30% 70% 70%' }}>
                <Image
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-rose-powder/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                  <div className="absolute bottom-4 left-4 right-4">
                    <p className="text-white font-semibold text-lg">Nos activités</p>
                  </div>
                </div>
              </div>
              ...
              {/* Photo 3 - Découpage et collage */}
              <div className="col-span-1 relative overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-105 animate-fade-in-up animate-delay-200 group"
              ...
              {/* Photo 4 - Carton */}
              <div className="col-span-1 relative overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-105 animate-fade-in-up animate-delay-300 group"
              ...
              {/* Photo 5 - Fabrication cabane */}
              <div className="col-span-1 relative overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-105 animate-fade-in-up animate-delay-400 group"
              ...
              {/* Photo 6 - Jeu de société */}
              <div className="col-span-1 relative overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-105 animate-fade-in-up animate-delay-500 group"
                   style={{ borderRadius: '50% 50% 30% 70% / 30% 70% 30% 70%' }}>
                <Image
              ...
              {/* Photo 7 - Pâtisserie */}
              <div className="col-span-1 relative overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-105 animate-fade-in-up animate-delay-600 group"
                   style={{ borderRadius: '65% 35% 60% 40% / 50% 50% 50% 50%' }}>
                <Image
              ...
              {/* Photo 8 - Peinture 2 */}
              <div className="col-span-1 relative overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-105 animate-fade-in-up animate-delay-700 group"
                   style={{ borderRadius: '45% 55% 50% 50% / 60% 35% 65% 40%' }}>
                <Image
