      ...
      <section className="py-12 md:py-16 bg-gray-soft">
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="mt-16 animate-fade-in-up">
            ...
            {/* Collage de photos - Mosaïque créative */}
            <div className="grid grid-cols-6 gap-3 max-w-6xl mx-auto mb-8">
              {/* Ligne 1 */}
              {/* Photo 1 - Peinture (large) */}
              <div className="col-span-6 md:col-span-3 md:row-span-2 relative overflow-hidden rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-[1.02] animate-fade-in-up group">
                <Image
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-rose-powder/90 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                  <div className="absolute bottom-6 left-6 right-6">
                    <p className="text-white font-bold text-xl">Atelier Peinture</p>
                    <p className="text-white/90 text-sm">Créativité et expression artistique</p>
                  </div>
                </div>
              </div>

              {/* Photo 2 - Coloriage */}
              <div className="col-span-3 md:col-span-2 relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-105 animate-fade-in-up animate-delay-100 group">
                <Image
                ...
                />
                <div className="absolute inset-0 bg-blue-sky/60 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-center justify-center">
                  <p className="text-white font-semibold text-sm">Coloriage</p>
                </div>
              </div>

              {/* Photo 3 - Jeux de société */}
              <div className="col-span-3 md:col-span-1 relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-105 animate-fade-in-up animate-delay-200 group">
                <Image
                  ...
                  className="w-full h-40 object-cover group-hover:scale-110 transition-transform duration-700"
                />
                <div className="absolute inset-0 bg-rose-powder/60 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-center justify-center">
                  <p className="text-white font-semibold text-sm text-center px-2">Jeux</p>
                </div>
              </div>

              {/* Ligne 2 */}
              {/* Photo 4 - Pâtisserie */}
              <div className="col-span-3 md:col-span-1 relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-105 animate-fade-in-up animate-delay-300 group">
                <Image
                ...
                />
                <div className="absolute inset-0 bg-blue-sky/60 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-center justify-center">
                  <p className="text-white font-semibold text-sm">Pâtisserie</p>
                </div>
              </div>

              {/* Photo 5 - Découpage et collage */}
              <div className="col-span-3 md:col-span-2 relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-105 animate-fade-in-up animate-delay-400 group">
                <Image
                ...
                />
                <div className="absolute inset-0 bg-rose-powder/60 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-center justify-center">
                  <p className="text-white font-semibold text-sm">Découpage & Collage</p>
                </div>
              </div>

              {/* Ligne 3 */}
              {/* Photo 6 - Peinture 2 */}
              <div className="col-span-3 md:col-span-2 relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-105 animate-fade-in-up animate-delay-500 group">
                <Image
                  src="/images/peinture2.avif"
                  alt="Atelier peinture créatif"
                  width={300}
                  height={200}
                  className="w-full h-40 object-cover group-hover:scale-110 transition-transform duration-700"
                />
                <div className="absolute inset-0 bg-blue-sky/60 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-center justify-center">
                  <p className="text-white font-semibold text-sm">Peinture créative</p>
                </div>
              </div>

              {/* Photo 7 - Carton */}
              <div className="col-span-3 md:col-span-2 relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-105 animate-fade-in-up animate-delay-600 group">
                <Image
                ...
                />
                <div className="absolute inset-0 bg-rose-powder/60 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-center justify-center">
                  <p className="text-white font-semibold text-sm">Création carton</p>
                </div>
              </div>

              {/* Photo 8 - Fabrication cabane */}
              <div className="col-span-6 md:col-span-2 relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-105 animate-fade-in-up animate-delay-700 group">
                <Image
                ...
                />
                <div className="absolute inset-0 bg-blue-sky/60 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-center justify-center">
                  <p className="text-white font-semibold text-sm">Construction cabane</p>
                </div>
              </div>
            </div>
