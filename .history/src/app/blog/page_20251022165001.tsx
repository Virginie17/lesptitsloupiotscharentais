      ...
      <div className="container max-w-6xl mx-auto">
        ...
        <Card className="bg-gradient-to-r from-pink-500 to-purple-500 text-white border-none">
          <CardContent className="p-8 text-center">
            <h2 className="text-3xl font-bold mb-3">📧 Recevez mes conseils par email</h2>
            <p className="text-lg mb-6 opacity-90">
              Inscrivez-vous à ma newsletter pour recevoir mes meilleurs conseils et astuces directement dans votre boîte mail.
            </p>
            <div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
              ...
              />
              <Button className="bg-white text-pink-500 hover:bg-gray-100 font-semibold px-8">
                S&apos;inscrire
              </Button>
            </div>
