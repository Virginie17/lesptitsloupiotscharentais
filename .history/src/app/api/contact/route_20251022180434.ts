...
// Configuration du transporteur Brevo (Sendinblue) SMTP
...
export async function POST(request: NextRequest) {
  try {
    ...
    // Envoi de l'email avec Nodemailer + Brevo SMTP
    const mailOptions = {
      from: `"Les Ptits Loupiots Charentais" <${process.env.BREVO_SMTP_USER}>`,
      to: 'lesptitsloupiotscharentais@gmail.com', // Votre adresse Gmail de réception
      replyTo: email,
