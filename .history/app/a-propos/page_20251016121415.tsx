          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-3xl shadow-lg p-8 md:p-12 mb-12">
              ...
              <div className="space-y-4 text-gray-600 text-lg">
                <p>
                  Bonjour ! Je m'appelle <span className="font-semibold text-gray-dark">Camille</span>, j'ai 21 ans et je suis passionnée par le monde de la petite enfance depuis toujours.
                </p>
                <p>
                  J'ai créé ma micro-entreprise <span className="font-semibold text-gray-dark">Les Ptits Loupiots Charentais</span> pour proposer des services de garde d'enfants à domicile de qualité, dans un cadre bienveillant et sécurisant.
                </p>
            ...
            <Card className="bg-gradient-to-br from-rose-powder/20 to-blue-sky/20 border-2 border-rose-powder mb-12">
              ...
              <CardContent className="text-center">
                <p className="text-lg text-gray-600 mb-4">
                  Mon agrément d'assistante maternelle est <span className="font-semibold text-gray-dark">prévu pour 2027</span>.
                </p>
                <p className="text-gray-600">
            ...
            <div className="text-center bg-white rounded-3xl shadow-lg p-8">
              ...
              <p className="text-gray-600 mb-6">
                N'hésitez pas à me contacter pour échanger sur vos besoins et faire connaissance !
              </p>
