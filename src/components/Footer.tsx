            ...
            <div className="space-y-3">
              ...
              <div className="pt-3 border-t border-gray-200">
                ...
                <div className="flex items-center space-x-3">
                  <a
                    href="https://www.facebook.com/share/1Bgxry9mNq/?mibextid=wwXIfr"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group p-2 rounded-full bg-gray-100 hover:bg-rose-powder transition-all duration-300 hover:scale-110"
                    aria-label="Facebook - Les Ptits loupiots Charentais"
                  >
                    <Facebook size={20} className="text-gray-600 group-hover:text-white transition-colors" />
                  </a>
                  <a
                    href="https://www.instagram.com/lesptitsloupiots_charentais?igsh=MTNtYnhhcjltcWthdg%3D%3D&utm_source=qr"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group p-2 rounded-full bg-gray-100 hover:bg-rose-powder transition-all duration-300 hover:scale-110"
                    aria-label="Instagram - @lesptisloupiots_charentais"
                  >
